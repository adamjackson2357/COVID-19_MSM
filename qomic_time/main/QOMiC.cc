...
int main(int argc, char *  argv[])
{
    ...
    char filename_in_hospital[1000];
    ...
    while(na < argc){
        ...
        else if ( 0 == strcmp(argv[na],"-hospital") ){
            strcpy(filename_in_hospital,argv[++na]);
            if (na+1==argc) break;
            na++;
        }
    ...
    mat_hospital.Read_from_file(filename_in_hospital);
    ...
    mat_hospital.Free_double_matrix_cont();
